...
public class ProjectTests {
  ...
  @Test
  public void testDeduplicateManyElems1() {
     ArrayList<Integer> intList = new ArrayList<Integer>();
     intList.add(6);
     intList.add(6);
     intList.add(6);
  ...
  @Test
  public void testDeduplicateManyElems2() {
     ArrayList<Integer> intList = new ArrayList<Integer>();
     intList.add(25);
     intList.add(6);
     intList.add(6);
  ...
  @Test
  public void testDeduplicateManyElems3() {
     ArrayList<Integer> intList = new ArrayList<Integer>();
     intList.add(25);
     intList.add(6);
     intList.add(3);
  ...
  @Test
  public void testDeduplicateManyElems4() {
     ArrayList<Integer> intList = new ArrayList<Integer>();
     intList.add(25);
     intList.add(6);
     intList.add(3);
  ...
  @Test
  public void testGetSetIntersection1EmptyArg() {
     ArrayList<Integer> dataSet1 = new  ArrayList<Integer>();
     ArrayList<Integer> dataSet2 = new  ArrayList<Integer>();
     dataSet2.add(92);
     dataSet2.add(54);
  ...
  public void testGetSetIntersection2() {
    ...
    @Test
    public void testGetSetDifference1EmptyArg() {
       ArrayList<Integer> dataSet1 = new  ArrayList<Integer>();
       ArrayList<Integer> dataSet2 = new  ArrayList<Integer>();
       dataSet2.add(92);
       dataSet2.add(54);
